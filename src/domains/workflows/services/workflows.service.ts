...
export const WORKFLOW_TEMPLATES: Record<string, Partial<WorkflowDefinition>> = {
  ...
  // ============================================================
  // Voice & Audio Workflow Templates
  // ============================================================

  'voice-cloning-complete': {
    name: 'Complete Voice Cloning Pipeline',
    description: 'Record voice sample, clone voice, generate script with emotion control, and create TTS audio',
    version: '1.0.0',
    steps: [
      {
        id: 'record-voice-sample',
        name: 'Record Voice Sample (>30s)',
        handler: 'voice-record',
        timeout: 60,
      },
      {
        id: 'clone-voice',
        name: 'Clone Voice from Sample',
        handler: 'voice-clone-service',
        dependencies: ['record-voice-sample'],
        timeout: 120,
        retryPolicy: {
          maxAttempts: 3,
          backoffMultiplier: 2,
      ...
      {
        id: 'generate-script',
        name: 'Generate Script with Emotion Control',
        handler: 'workers-ai-script-generator',
        dependencies: ['clone-voice'],
        timeout: 60,
      },
      {
        id: 'validate-script',
        name: 'Validate Script Content',
        handler: 'script-validator',
        dependencies: ['generate-script'],
        timeout: 10,
      },
      {
        id: 'generate-tts',
        name: 'Generate TTS with Cloned Voice',
        handler: 'workers-ai-tts-with-emotion',
      ...
      {
        id: 'optimize-audio',
        name: 'Optimize Audio Quality',
        handler: 'audio-optimize',
        dependencies: ['generate-tts'],
        timeout: 30,
      },
      {
        ...
        handler: 'r2-upload-audio',
        dependencies: ['optimize-audio'],
        timeout: 30,
      },
      {
        id: 'save-metadata',
        name: 'Save Audio Metadata to D1',
        handler: 'd1-save-audio-metadata',
        dependencies: ['upload-to-r2'],
        timeout: 10,
      },
    ],
  },
  ...
  'audio-processing-pipeline': {
    ...
    description: 'Process audio files with format conversion, optimization, and metadata extraction',
    version: '1.0.0',
    steps: [
      {
        id: 'download-audio',
        name: 'Download Audio Source',
      ...
      },
      {
        ...
        handler: 'audio-extract-metadata',
        dependencies: ['validate-format'],
        timeout: 10,
      },
      {
        id: 'convert-format',
        name: 'Convert Audio Format (if needed)',
        handler: 'audio-convert-format',
      ...
      },
      {
        id: 'optimize-quality',
        name: 'Optimize Audio Quality',
        handler: 'audio-optimize-quality',
        dependencies: ['convert-format'],
        timeout: 30,
      },
      {
        id: 'normalize-volume',
        name: 'Normalize Volume',
        handler: 'audio-normalize',
        dependencies: ['optimize-quality'],
        timeout: 30,
      },
      {
        id: 'generate-waveform',
        name: 'Generate Waveform Data',
        handler: 'audio-generate-waveform',
        dependencies: ['normalize-volume'],
        timeout: 10,
      },
      {
        id: 'upload-to-r2',
        name: 'Upload Processed Audio to R2',
        handler: 'r2-upload-processed',
        dependencies: ['generate-waveform'],
        timeout: 30,
      },
    ],
  },
  ...
  'batch-tts-generation': {
    name: 'Batch TTS Generation',
    description: 'Generate TTS for multiple texts with parallel processing',
    version: '1.0.0',
    steps: [
      {
        id: 'fetch-texts',
        name: 'Fetch Texts to Convert',
        handler: 'batch-fetch-texts',
        timeout: 30,
      },
      {
        id: 'batch-generate-tts',
        name: 'Generate TTS in Batches',
        handler: 'workers-ai-batch-tts',
        dependencies: ['fetch-texts'],
        timeout: 300,
        retryPolicy: {
          maxAttempts: 3,
          backoffMultiplier: 2,
      ...
      },
      {
        ...
        handler: 'audio-combine-batch',
        dependencies: ['batch-generate-tts'],
        timeout: 60,
      },
      {
        id: 'upload-to-r2',
        name: 'Upload Combined Audio to R2',
        handler: 'r2-upload-batch',
        dependencies: ['combine-audio'],
        timeout: 30,
      },
    ],
  },
  ...
  'podcast-automation': {
    ...
    description: 'Generate podcast episodes with AI narration, intro/outro, and background music',
    version: '1.0.0',
    steps: [
      {
        id: 'generate-script',
        name: 'Generate Podcast Script',
        handler: 'workers-ai-podcast-script',
        timeout: 90,
      },
      {
        id: 'generate-intro',
        name: 'Generate Intro TTS',
        handler: 'workers-ai-tts-intro',
        dependencies: ['generate-script'],
        timeout: 60,
      },
      {
        id: 'generate-content',
        name: 'Generate Content TTS',
        handler: 'workers-ai-tts-content',
        dependencies: ['generate-script'],
        timeout: 180,
      },
      {
        id: 'generate-outro',
        name: 'Generate Outro TTS',
        handler: 'workers-ai-tts-outro',
        dependencies: ['generate-script'],
        timeout: 60,
      },
      {
        ...
        handler: 'audio-add-music',
        dependencies: ['generate-intro', 'generate-content', 'generate-outro'],
        timeout: 60,
      },
      {
        id: 'combine-tracks',
        name: 'Combine All Tracks',
        handler: 'audio-combine-podcast',
        dependencies: ['add-background-music'],
        timeout: 60,
      },
      {
        id: 'master-audio',
        name: 'Master Final Audio',
        handler: 'audio-master',
        dependencies: ['combine-tracks'],
        timeout: 60,
      },
      {
        id: 'upload-to-r2',
        name: 'Upload to R2',
        handler: 'r2-upload-podcast',
        dependencies: ['master-audio'],
        timeout: 30,
      },
      {
        id: 'create-rss-entry',
        name: 'Create RSS Entry',
        handler: 'rss-create-entry',
        dependencies: ['upload-to-r2'],
        timeout: 10,
      },
    ],
  ...
  'audiobook-creation': {
    ...
    description: 'Create audiobooks from text with chapter separation and voice consistency',
    version: '1.0.0',
    steps: [
      {
        id: 'parse-chapters',
        name: 'Parse Book Chapters',
        handler: 'book-parse-chapters',
        timeout: 30,
      },
      {
        id: 'generate-chapter-tts',
        name: 'Generate TTS for Each Chapter',
        handler: 'workers-ai-chapter-tts',
        dependencies: ['parse-chapters'],
        timeout: 600,
        retryPolicy: {
          maxAttempts: 3,
          backoffMultiplier: 2,
      ...
      },
      {
        ...
        handler: 'audio-combine-book',
        dependencies: ['generate-chapter-tts'],
        timeout: 120,
      },
      {
        id: 'add-meta-tags',
        name: 'Add Audiobook Metadata Tags',
        handler: 'audio-add-metadata',
        dependencies: ['combine-chapters'],
        timeout: 10,
      },
      {
        id: 'upload-to-r2',
        name: 'Upload Audiobook to R2',
        handler: 'r2-upload-audiobook',
        dependencies: ['add-meta-tags'],
        timeout: 60,
      },
      {
        id: 'save-metadata',
        name: 'Save Audiobook Metadata to D1',
        handler: 'd1-save-book-metadata',
        dependencies: ['upload-to-r2'],
        timeout: 10,
      },
    ],
